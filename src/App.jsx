...
function App() {
  ...
  const inputs=[
    ...
    },
    {
      ...
      type:"email",
      placeholder:"Email",
      errorMessage:"It must be a valid email Id",
      label:"Email",
      required:true
    },
    {
    ...
    },
    {
      ...
      errorMessage:"Password should be 8-20 charaacters and include at least 1 letter, 1 number and 1 special character",
      label:"Password",
      required:true
    },
    {
